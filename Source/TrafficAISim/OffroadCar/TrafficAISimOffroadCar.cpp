...
#include "TrafficAISimOffroadCar.h"
#include "TrafficAISimOffroadWheelFront.h"
#include "TrafficAISimOffroadWheelRear.h"
...
ATrafficAISimOffroadCar::ATrafficAISimOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UTrafficAISimOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UTrafficAISimOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UTrafficAISimOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UTrafficAISimOffroadWheelRear::StaticClass();
