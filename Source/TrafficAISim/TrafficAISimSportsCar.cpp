...
#include "TrafficAISimSportsCar.h"
#include "TrafficAISimSportsWheelFront.h"
#include "TrafficAISimSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ATrafficAISimSportsCar::ATrafficAISimSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UTrafficAISimSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UTrafficAISimSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UTrafficAISimSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UTrafficAISimSportsWheelRear::StaticClass();
